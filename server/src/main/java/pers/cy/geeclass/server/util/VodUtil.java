...
//        request.setTemplateGroupId("78fffb8c0c2426efd5baaaafed76fe36");
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI5tCRWk4ZHUH6UuaDQ89v";
        //您的AccessKeySecret
        String accessKeySecret = "P5AkZwL2dsWB9tvHolj4IajkIAuqaO";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "C:\\我的电脑\\文档\\开发项目\\geeclass\\admin\\public\\static\\image\\小节视频\\test.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
